<%-- 
    Document   : nosotros
    Created on : 25-may-2017, 16:25:51
    Author     : Admin
--%>
...
<html lang="es">
  <head>
    ...
    <title>Nosotros | Ferreteria</title>
  </head>
  <body>
        ...
        <div class="ed-item">
          ...
          <nav id="menu" class="menu-container">
            ...
            <ul class="ed-menu web-horizontal">
              ...
              <li><a href="nosotros.jsp" class="selected">nosotros</a></li>
    ...
    <div class="l-main ed-container">
      <div class="ed-item">
        <div class="ed-container web-80">
          ...
          <div class="ed-item tablet-40 web-25"><img src="img/vendedor.jpg"/></div>
        </div>
      </div>
    </div>
