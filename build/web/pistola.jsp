<%-- 
    Document   : esmalte
    Created on : 25-may-2017, 17:57:07
    Author     : Admin
--%>
...
<html lang="es">
  <head>
    ...
    <title>Esmalte | Ferreteria</title>
  </head>
  <body>
        ...
        <div class="ed-item">
          ...
          <nav id="menu" class="menu-container">
            ...
            <ul class="ed-menu web-horizontal">
              ...
              <li><a href="productos.jsp" class="selected">productos</a></li>
    ...
    <div class="l-main ed-container">
      <div class="ed-item">
        ...
        <div class="ed-container product__page">
          <div class="ed-item tablet-50"><img src="img/pistola_de_calor.jpg" class="product__page__img"/></div>
